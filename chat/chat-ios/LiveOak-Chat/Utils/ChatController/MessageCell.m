...
static NSString * kMessageUser = @"name";
static NSString * kMessageContent = @"content";
static NSString * kMessageTimestamp = @"timestamp";
#else
NSString * const kMessageUser = @"name";
NSString * const kMessageContent = @"text";
...
- (void) drawCell {
    ...
    _textLabel.text = [NSString stringWithFormat:@"%@: %@", _message[kMessageUser], _message[kMessageContent]];
